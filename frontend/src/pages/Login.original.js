/**
 * Login Page
 * User authentication form with beautiful animations and motivational quotes
 */
...
const Login = () => {
  ...
  useEffect(() => {
    // Set a motivational quote on mount
    setQuote(getRandomQuote('motivation'));
  }, []);
        ...
        <div className="max-w-md w-full space-y-6">
          ...
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-600">
              Professional ECG Monitoring at Home
            </p>
          </div>

          {/* Motivational Quote Card */}
          {quote && (
            <div className="bg-gradient-to-r from-primary-50 to-success-50 border border-primary-100 rounded-xl p-4 hover-lift">
